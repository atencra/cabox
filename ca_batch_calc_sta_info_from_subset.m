function ca_batch_calc_sta_info_from_subset
% ca_batch_calc_sta_info_from_subset Batch cell assembly STA information
% 
% ca_batch_calc_sta_info_from_subset() looks inside the current

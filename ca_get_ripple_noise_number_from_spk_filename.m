...
if ( ~isempty(findstr(filename, '-rn1-')) || ...
     ~isempty(findstr(filename, '-rn11-')) || ...     
     ~isempty(findstr(filename, '-rn12-')) || ...     
     ~isempty(findstr(filename, 'dmr')) )
    rn = 1;
elseif ( ~isempty(findstr(filename, '-rn4-')) || ...
         ~isempty(findstr(filename, '-rn41-')) || ...     
         ~isempty(findstr(filename, '-rn42-')) )
    rn = 4;
elseif ( ~isempty(findstr(filename, '-rn8-')) || ...
         ~isempty(findstr(filename, '-rn81-')) || ...     
         ~isempty(findstr(filename, '-rn82-')) )
    rn = 8;

function [stimstr] = ca_get_ripple_noise_stimulus(abspath, rn, dft, dff)
...
if ( dft > 0 )
    file_middle = sprintf('rn%.0f-*-96khz-48DF-10min_DFt%.0f_DFf%.0f', rn, dft, dff);
else
    file_middle = sprintf('rn%.0f-*-96khz-48DF-10min', rn);
end

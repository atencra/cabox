function nedata = ca_spkmatrix_to_ensembles(SpikeCount,opts)
...
% Return eval distribution, m-p bounds
nedata.corrmat = CorrMatrix;
nedata.neurons = size(zSpikeCount,2);
nedata.timebins = size(zSpikeCount,1);
nedata.q = q;
nedata.ensembles = AssemblyTemplates;
nedata.eigenvalues = eigenvalues;
nedata.lambda_max = lambda_max;
nedata.lambda_min = lambda_min;

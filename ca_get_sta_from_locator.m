function sta = ca_get_sta_from_locator(locator, stimulus, numtbins)
% ca_get_sta_from_locator - calculate STA from spike train vector and
%    a stimulus matrix
%
% sta = ca_get_sta_from_locator(locator, stimulus, numtbins)
% ----------------------------------------------------
%
% locator : vector of integers, where values greater
%           than one imply a spike, and values of 0
%           imply no spike. This is a binned spike train.
%
